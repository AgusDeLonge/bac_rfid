...
<%
	...
	try {
		...
		_ps.setString(++_i, request.getParameter("id"));
		_ps.setString(++_i, request.getParameter("house_id"));
		_ps.setString(++_i, request.getParameter("name"));
		_ps.setInt(++_i, Integer.parseInt(request.getParameter("owner")));
